...
// User-oota role isaanii 'owner' ta'e fiduu (Prepared Statement fayyadamna)
...
<head>
    <meta charset="utf-8">
    <title>Smart Home Finder - Manage Owners</title>
...
<div class="main-content" style="padding: 20px;">
    ...
    <table width="100%" border="0" cellpadding="15" style="background: white; border-radius: 10px; border-collapse: collapse; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
        ...
        <?php else: ?>
            <tr>
                <td colspan="5" style="text-align: center; padding: 40px; color: #666;">No house owners found registered.</td>
            </tr>
        <?php endif; ?>
        </tbody>
    </table>
